...
public class sporeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.spore_fragment, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        listView = (ListView) getActivity().findViewById(R.id.listviewSpor);
        ...
        for (int i = 0; i < Haberler.size(); i++) {
            if (Haberler.get(i).type.contains("spor")) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
               ...
               // String displayed = yeniliste.get(position).displayed;
